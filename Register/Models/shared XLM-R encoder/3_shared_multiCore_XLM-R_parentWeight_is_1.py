...
# Parent labels
parents = list(labels_structure.keys())
...
#
hierarchical_labels = parents + children
...
for i, label in enumerate(children):
    print(
        f"{len(parents) + i:2d}: "
        f"{label} -> {child_to_parent[label]}"
    )

print("\nTotal labels:", len(hierarchical_labels))
...
RESULTS_ROOT = (
    DATASET_ROOT
    / "_MultiCore_Hierarchical_sharedRep_finetuned_evaluation_ParentWeight1"
)
...
# Your pretrained multilingual web-register model
MODEL_ID = (
...
#
# IMPORTANT:
# We save dev logits later so you can tune thresholds
# independently.
#
THRESHOLD = 0.5
...
if task_id >= len(dataset_dirs):
    ...
    raise IndexError(
        ...
        f"but only {len(dataset_dirs)} datasets "
        "were found."
    )
...
def make_hierarchical_labels(example):
    ...
    for parent in parents:
        ...
        parent_value = label_values[parent]


        # If ANY child is positive,
        # the parent must also be positive.
        #
        # Example:
        #
        # en = 1
    ...
    for child in children:
        ...
        child_value = label_values[child]
...
print("Dev:", len(validation_dataset))
...
# ============================================================
# Hierarchical XLM-R model
# ============================================================

class HierarchicalXLMR(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        #
        # XLM-R uses <s> as the first token.
        # ----------------------------------------------------
...
# Model factory
#
# This ensures that every Optuna trial and the final model
...
def compute_metrics(eval_prediction):
    ...
    return {
        ...
        "parent_micro_f1": parent_micro_f1,

        # Child
        "child_macro_f1": child_macro_f1,
        "child_micro_f1": child_micro_f1,
    }
...
class OptunaPruningCallback(
    ...
    def on_evaluate(
        ...
        **kwargs,
        ...
        # ----------------------------------------------------
        # We optimize child macro F1.
        #
        # This is the most relevant metric for your actual
        # fine-grained register classification.
        # ----------------------------------------------------
...
def objective(trial):
    ...
    args = TrainingArguments(
        ...
        # IMPORTANT:
        # Optimize fine-grained child performance.
